...
public class AggregateResource {
	 ...
	 *         contactDTO, or with status 400 (Bad Request) if the contact has
	 *         already an ID
	 ...
	 *         contactDTO, or with status 400 (Bad Request) if the contactDTO is not
	 *         valid, or with status 500 (Internal Server Error) if the contactDTO
	 *         couldn't be updated
	 * @throws URISyntaxException if the Location URI syntax is incorrect
	 */
	@PutMapping("/contacts")
	...
	public ResponseEntity<ContactDTO> updateContact(@RequestBody ContactDTO contactDTO) throws URISyntaxException {
		...
		return ResponseEntity.ok()
				.headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, contactDTO.getId().toString())).body(result);
	}
	 ...
	 * @return the ResponseEntity with status 201 (Created) and with body the new
	 *         addressDTO, or with status 400 (Bad Request) if the address has
	 *         already an ID
	 * @throws URISyntaxException if the Location URI syntax is incorrect
	 */
	 ...
	 * @return the ResponseEntity with status 200 (OK) and with body the updated
	 *         addressDTO, or with status 400 (Bad Request) if the addressDTO is not
	 *         valid, or with status 500 (Internal Server Error) if the addressDTO
	 *         couldn't be updated
	 * @throws URISyntaxException if the Location URI syntax is incorrect
	 */
	 ...
	 *
	 * @param pageable the pagination information
	 * @return the ResponseEntity with status 200 (OK) and the list of bloodGroups
	 *         in body
	 */
