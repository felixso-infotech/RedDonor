...
import { BloodGroupComponent } from 'app/entities/RedDonor/blood-group/blood-group.component';
...
describe('Component Tests', () => {
  describe('BloodGroup Management Component', () => {
    let comp: BloodGroupComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BloodGroupComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bloodGroups[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
